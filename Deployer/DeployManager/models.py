...
class Deployment(models.Model):
    ...
    current_app_version = models.CharField(max_length=200, blank=True)
    app_location = models.CharField(max_length=200, blank=True)
    username = models.CharField(max_length=200)
    private_key = models.ForeignKey('KeyPair', blank=True, null=True)
    fabfile = models.FileField(upload_to=settings.FABFILE_ROOT, blank=True)
