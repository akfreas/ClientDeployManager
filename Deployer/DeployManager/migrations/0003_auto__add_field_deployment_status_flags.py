...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.status_flags'
        db.add_column(u'DeployManager_deployment', 'status_flags',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.status_flags'
        db.delete_column(u'DeployManager_deployment', 'status_flags')
