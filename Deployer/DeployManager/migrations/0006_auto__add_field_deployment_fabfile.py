...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.fabfile'
        db.add_column(u'DeployManager_deployment', 'fabfile',
                      self.gf('django.db.models.fields.files.FileField')(default='pwd', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.fabfile'
        db.delete_column(u'DeployManager_deployment', 'fabfile')
    ...
    models = {
        ...
        u'DeployManager.deployment': {
            ...
            'fabfile': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
